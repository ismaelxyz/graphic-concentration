...
def BuildTexture(path):
    ...
    Picture = Picture.resize(
        (resizeWidthPixels, resizeHeightPixels), Image.BICUBIC)
    ...
    glTexImage2D(GL_TEXTURE_2D, 0, 3, lWidthPixels, lHeightPixels,
...
def main():
    ...
    window = glutCreateWindow(
        "NeHe's Volumetric Fog & IPicture Image Loading Tutorial")
