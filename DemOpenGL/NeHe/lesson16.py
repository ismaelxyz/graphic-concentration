...
def DrawGLScene():
    ...
    glTexCoord2f(1.0, 0.0)  # Bottom Right Of The Texture and Quad
    glTexCoord2f(1.0, 1.0)  # Top Right Of The Texture and Quad
    glTexCoord2f(0.0, 1.0)  # Top Left Of The Texture and Quad
