...
def InitGL(Width, Height):
    ...
    # FYI, the ttf font file "Test.ttf" in lesson43 is the typeface "Unifont Black Italic".
    # our_font = glFreeType.font_data ("ARBLI___.ttf", 16)
    our_font[0] = glFreeType.font_data('unifont.ttf', 16)
...
def DrawGLScene():
    ...
    our_font[0].glPrint(320, 240, "Active FreeType Text - %7.2f" % (cnt1))
    glPopMatrix()

    # Uncomment this to test out print's ability to handle newlines.
    our_font[0].glPrint(0, 0, "Here\nthere\nbe\n\nnewlines %f\n." % (cnt1))
    print('here')
    cnt1 += 0.051
    # cnt2 += 0.005
