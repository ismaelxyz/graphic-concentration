...
class glCamera:
    ...
    def UpdateFrustum(self):
        ...
        clip[12] = modl[12] * proj[0] + modl[13] * \
            proj[4] + modl[14] * proj[8] + modl[15] * proj[12]
        clip[13] = modl[12] * proj[1] + modl[13] * \
            proj[5] + modl[14] * proj[9] + modl[15] * proj[13]
    ...
    def UpdateFrustumFaster(self):
        ...
        # /* Normalize the result */
        t = sqrt((Frustum[0][0] * Frustum[0][0]) + (Frustum[0]
                                                    [1] * Frustum[0][1]) + (Frustum[0][2] * Frustum[0][2]))
        Frustum[0][0] /= t
        Frustum[0][1] /= t
        Frustum[0][2] /= t
        Frustum[0][3] /= t
        ...
        # /* Normalize the result */
        t = sqrt((Frustum[4][0] * Frustum[4][0]) + (Frustum[4]
                                                    [1] * Frustum[4][1]) + (Frustum[4][2] * Frustum[4][2]))
        Frustum[4][0] /= t
        Frustum[4][1] /= t
        Frustum[4][2] /= t
        Frustum[4][3] /= t
    ...
    def IsOccluded(self, p):
        ...
        winx, winy, winz = gluProject(
            p.x, p.y, p.z, mvmatrix, projmatrix, viewport)
        flareZ = winz
    ...
    def SetPrespective(self):
        ...
        glTranslatef(-self.m_Position.x, -
                     self.m_Position.y, -self.m_Position.z)
        return
