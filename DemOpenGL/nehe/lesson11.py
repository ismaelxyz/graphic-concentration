...
def DrawGLScene():
    ...
    # for division our flag on small quads
    float_x = float_y = float_xb = float_yb = 0.0
    ...
    for x in range(45):
        for y in range(45):
            ...
            glVertex3f(points[x+1][y+1][0], points[x+1]
                       [y+1][1], points[x+1][y+1][2])
    ...
    if w_count == 2:  # for slowing the wave
        for y in range(45):  # walk on plane Y
            # save the current value of left side one point
            hold = points[0][y][2]
