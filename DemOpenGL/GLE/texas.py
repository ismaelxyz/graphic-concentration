...
points = (
    (-1.5, 2.0),   (-0.75, 2.0),   (-0.75, 1.38),
    (-0.5, 1.25),  (0.88, 1.12),   (1.0, 0.62),
    (1.12, 0.1),   (0.5, -0.5),    (0.2, -1.12),
    (0.3, -1.5),   (-0.25, -1.45), (-1.06, -0.3),
    (-1.38, -0.3), (-1.65, -0.6),  (-2.5, 0.5),
    (-1.5, 0.5),   (-1.5, 2.0),    (-0.75, 2.0)
)
...
for i in range(len(texas_xsection)):
    tcolors.append((((i*33) % 255)/255.0, ((i*47) % 255)/255.0,
                    ((i*89) % 255)/255.0))
...
def DrawStuff():
    ...
    gleSetJoinStyle(TUBE_NORM_FACET | TUBE_JN_ANGLE |
                    TUBE_CONTOUR_CLOSED | TUBE_JN_CAP)
    glPushMatrix()
    ...
    gleExtrusion(texas_xsection, texas_normal,
                 None, brand_points, brand_colors)
