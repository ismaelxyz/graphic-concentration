...
fn load_media<T>(renderer: &TextureCreator<T>) -> HashMap<&'static str, Box<Texture>> {
    ...
    map.insert(
        "down",
        Box::new(load_texture("resources/down.bmp", renderer)),
    );
    map.insert(
        "left",
        Box::new(load_texture("resources/left.bmp", renderer)),
    );
    map.insert(
        "right",
        Box::new(load_texture("resources/right.bmp", renderer)),
    );
    map.insert(
        "press",
        Box::new(load_texture("resources/press.bmp", renderer)),
    );
    map
}
