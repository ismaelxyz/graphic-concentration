...
function __wbg_adapter_24(arg0, arg1) {
    wasm._dyn_core__ops__function__FnMut_____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h7c015ecae53b4f49(arg0, arg1);
}

/**
* @param {string} canvas_id
*/
export function lesson2(canvas_id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.lesson2(retptr, ptr0, len0);
...
/**
* Configura la HTML para la presentación de este proyecto.
*/
...
* @param {string} canvas_id
*/
export function lesson3(canvas_id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.lesson3(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
* @param {string} canvas_id
*/
export function lesson1(canvas_id) {
    try {
        const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        wasm.lesson1(retptr, ptr0, len0);
        var r0 = getInt32Memory0()[retptr / 4 + 0];
        var r1 = getInt32Memory0()[retptr / 4 + 1];
        if (r1) {
            throw takeObject(r0);
...
/**
*/
export class LessonCursor {

    static __wrap(ptr) {
        const obj = Object.create(LessonCursor.prototype);
        obj.ptr = ptr;
    ...
    free() {
        ...
        wasm.__wbg_lessoncursor_free(ptr);
    }
    /**
    * @param {string} id
    */
    constructor(id) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.lessoncursor_new(ptr0, len0);
        return LessonCursor.__wrap(ret);
    }
    /**
    */
    next() {
        wasm.lessoncursor_next(this.ptr);
    }
    /**
    */
    back() {
        wasm.lessoncursor_back(this.ptr);
    }
}
...
async function init(input) {
    if (typeof input === 'undefined') {
        input = new URL('wasmgl_beginning_bg.wasm', import.meta.url);
    }
    const imports = getImports();
